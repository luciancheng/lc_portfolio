...
const Projects = () => {
    const projects = [
    {title: "Portfolio Website", desc: "Built a React JS portoflio website to display my experiences and projects in a visually appealing manner", skills: ["html", "css", "js", "react"], links: "https://github.com/luciancheng/LucianChengPortfolio", img: webdev},
